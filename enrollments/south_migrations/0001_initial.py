...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ticket', (
            ...
            ('precollege', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['institutions.PreCollege'])),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['institutions.Season'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'enrollments', ['Ticket'])

        # Adding model 'TicketDetail'
        db.create_table('ticket_detail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticket_details', to=orm['enrollments.Ticket'])),
            ('week', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticket_details', to=orm['institutions.Week'])),
        ))
        db.send_create_signal(u'enrollments', ['TicketDetail'])
        ...
        db.create_table('enrollment', (
            ...
            ('week', self.gf('django.db.models.fields.related.ForeignKey')(related_name='enrollments', to=orm['institutions.Week'])),
        ))
        db.send_create_signal(u'enrollments', ['Enrollment'])

        # Adding unique constraint on 'Enrollment', fields ['student', 'week']
        db.create_unique('enrollment', ['student_id', 'week_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Enrollment', fields ['student', 'week']
        db.delete_unique('enrollment', ['student_id', 'week_id'])

        # Deleting model 'Ticket'
        db.delete_table('ticket')

        # Deleting model 'TicketDetail'
        db.delete_table('ticket_detail')
    ...
    models = {
        ...
        u'enrollments.ticketdetail': {
            'Meta': {'object_name': 'TicketDetail', 'db_table': "'ticket_detail'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ticket_details'", 'to': u"orm['enrollments.Ticket']"}),
            'week': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ticket_details'", 'to': u"orm['institutions.Week']"})
        },
